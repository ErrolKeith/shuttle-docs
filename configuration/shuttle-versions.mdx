...
<Info>
  Note: Please check the [release
  page](https://github.com/shuttle-hq/shuttle/releases) for any considerations
  regarding breaking changes in the new release.
</Info>
...
5. Finally, redeploy your Shuttle app: `cargo shuttle deploy`. _(if you want to, commit your changes first)_
