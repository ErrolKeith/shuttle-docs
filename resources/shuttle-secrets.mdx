...
root of your project, these secrets will be used for local runs. The `Secrets.dev.toml` file will _only_ be used for local runs.
...
This command will delete _all_ secrets from your project.
